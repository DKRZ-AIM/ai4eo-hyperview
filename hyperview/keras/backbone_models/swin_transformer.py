...
import os
from tensorflow.keras.layers import Dense, Dropout, Conv2D,Conv1D, LayerNormalization, GlobalAveragePooling1D
import math
...
class SwinTransformerModel2(tf.keras.Model):
    def __init__(self, model_name='swin_tiny_patch4_window7_224', include_top=False,
                 img_size=(224, 224), patch_size=(4, 4), in_chans=3, num_classes=1000,
                 embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24],
                 window_size=7, mlp_ratio=4., qkv_bias=True, qk_scale=None,
