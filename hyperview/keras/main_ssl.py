...
parser.add_argument('--num-epochs', default=2, type=int, metavar='NE', help='number of epochs to train (default: 120)')
...
parser.add_argument('-l','--learning-rate', default=0.0001, type=float, metavar='LR', help='learning rate (default: 0.01)')
