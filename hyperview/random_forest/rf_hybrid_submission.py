...
def make_submission(preds, args):
...
def main(args):
    ...
    preds = {}
    for i in range(4):
        f'model_ix{i}' = os.path.join(args.model_path, args.models[i]
        with open(f'model_ix{i}', 'rb') as f_in:
    ...
    # make submission
    make_submission(preds, args)
            
if __name__ == '__main__':

    parser = argparse.ArgumentParser()
    argparse.add_argument(--model-path, type="str", default="../models")
    argparse.add_argument(--models, type="str", nargs='+', 
            default=['RandomForest_SIMPLE_202204231458_nest=1051_maxd=None_minsl=5.bin',
                     ...
                     'RandomForest_SIMPLE_202204231946_nest=901_maxd=None_minsl=5.bin'],
            help='models in index order 0 to 3')

    argparse.add_agument(--indata, type="str",
